          ...
          fallback={
            <div className="d-flex align-items-center vh-100 justify-content-center text-center font-weight-bold font-size-lg py-3">
              <div className="w-50 mx-auto">
                Please wait while we load the Frame
              </div>
            </div>
          }>
          <Switch>
              ...
              <LeftSidebar>
                <Switch location={location} key={location.pathname}>
                  <motion.div
                    ...
                    {/**App Routes*/}
                    <Route path="/enroll-staff" component={EnrollStaff} />
                    <Route path="/view-staffs" component={ViewStaff} />
                    <Route path="/staff-permissions" component={StaffPermission} />
                    ...
                    <Route path="/make-savings-transaction" component={MakeTransaction} />
                    <Route path="/view-savings-account" component={ViewSavingsAccount} />
                    <Route path="/savings-transaction-history" component={SavingsTransactionHistory} />
                    <Route path="/add-fixed-deposit" component={AddFixedDeposit} />
                  </motion.div>
                </Switch>
              </LeftSidebar>
            </Route>
